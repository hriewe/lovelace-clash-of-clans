...
let ClashOfClansCardEditor = class ClashOfClansCardEditor extends i {
    get _infoEntities() {
        if (!this.hass?.states)
            return [];
...
__decorate([
    n({ attribute: false })
], ClashOfClansCardEditor.prototype, "hass", void 0);
__decorate([
    n({ attribute: false })
], ClashOfClansCardEditor.prototype, "_config", void 0);
ClashOfClansCardEditor = __decorate([
    t("clash-of-clans-card-editor")
], ClashOfClansCardEditor);

let ClashOfClansCard = class ClashOfClansCard extends i {
    // -------------------- Lovelace hooks --------------------
    ...
    get relatedEntities() {
        ...
        if (this.playerTag) {
            return states.filter((e) => e.attributes?.player_tag === this.playerTag);
        }
        return states;
    }
...
__decorate([
    n({ attribute: false })
], ClashOfClansCard.prototype, "hass", void 0);
__decorate([
    n()
], ClashOfClansCard.prototype, "config", void 0);
ClashOfClansCard = __decorate([
    t("clash-of-clans-card")
], ClashOfClansCard);
// -------------------- card registration --------------------
